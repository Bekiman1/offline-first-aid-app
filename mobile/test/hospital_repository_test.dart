...
void main() {
  group('HospitalRepositoryImpl Tests', () {
    ...
    test('updateHospitalsFromRemote should add a hospital to the box', () async {
      ...
      final lastHospital = HospitalModel.fromJson(Map<String, dynamic>.from(box.values.last));
